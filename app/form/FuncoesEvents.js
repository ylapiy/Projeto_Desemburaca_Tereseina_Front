...
window.addEventListener('onload', () =>{
    const butao = document.querySelector('.submit-btn');
    if(localStorage.getItem(SerReiniciar) === false){tentarEnviar();}else{butao.disabled = true;var contador = 0;loopDeAnim(contador,"Denúncia salva, esperando conexão com a internet para finalizar a denúncia")
    }
